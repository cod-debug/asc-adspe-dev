          ...
          <q-card bordered :square="true" class="q-pa-md q-mt-md">
            ...
            <q-card-section>
              ...
              <div class="q-mt-xl" v-if="parentData.subDocUrl">
                ...
                <q-btn class="bg-red-14 text-white" style="width: 100%;" block label="Add to List" icon="task_alt" />    
