        ...
        <q-form>
          ...
          <q-card bordered :square="true" class="q-pa-md q-mt-md">
            ...
            <div v-if="parentData.type_of_media == 'SINGLE MEDIA'">
              <div v-for="(i, k) in parentData.type_of_medium" :key="k" class="row">
                ...
                <div class="col-4 col-md-4 q-pa-sm"  v-if="i.type_of_medium.length && k == 0" >
                  <q-input outlined label="Size / Length (in seconds)" v-model="i.length" disable />
                </div>
                <div class="col-4 col-md-4 q-pa-sm" v-if="i.type_of_medium.size && k == 0">
                  <q-input outlined label="Length" v-model="i.lengthSize" disable />
                </div>
            ...
            <div v-if="parentData.type_of_media == 'MULTIMEDIA'">
              <div class="col-sm-12 q-pa-sm">
                <div class="q-gutter-sm">
                  <q-radio dense v-model="isMoving" :val="true" label="MULTIMEDIA-MOVING" />
                  <q-radio dense v-model="isMoving" :val="false" label="MULTIMEDIA-STATIC (MAX OF 5 LAYOUT)" />
                </div>
              </div>
                  ...
                  <table class="w-100">
                    <tbody>
                      <tr v-for="(i, k) in type_of_medium_options" :key="k" class="row">
                        <td width="50%">
                          <q-checkbox :label="i.val" :val="i.type_of_medium" v-model="type_of_mediums_updated" />
                        </td>
                        <td v-if="!isMoving && i.val != 'DIGITAL STATIC'"  width="50%">
                          <q-input v-model="i.lengthSize" input-class="text-right" outlined />
                        </td>
